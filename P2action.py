...
aaa=["+","-"]
def P2action(남은마권카드,낸카드,horsename,horsecards,user_horsecard,P2_horsecard,P3_horsecard,actioncards,user_actioncard,P2_actioncard,P3_actioncard,user):
    if 낸카드 == "♞A ±1":
        print("♞+ or - 중 선택하시오."+"\t"*7+"      ♞")
        random.shuffle(aaa)
        쁠마 = aaa[0]
